...
contract Relay {
    ...
    mapping(uint256 => Chain) chains;
    // chain at position 0 is the main chain, others are forks
    mapping(uint256 => uint256) sorted_chains;
    // maxium chain id
    uint256 chain_ids;
    ...
    function get_chain_at_position(uint256 position)
        public
        view
        returns (
            uint256,
    ...
    function get_blocks_for_chain_id(uint256 id, uint256 height)
        public
        view
        returns (bytes32)
    {
    ...
    function get_max_chain_id() public view returns (uint256) {
        return chain_ids;
    }
}
